/**
* Programme qui comporte le TD2 à remettre le 29 septembre 2024
...
ListeJeux ajouterJeu(ListeJeux& listeJeux, Jeu* ptrJeu)
{
	...
	{
		Jeu** elementsCopie = new Jeu * [listeJeux.capacite * 2];
		int i = 0;
		for (auto jeuAjoute : spanListeJeux(listeJeux)) 
		{
			elementsCopie[i] = jeuAjoute;
			i++;
		}
		delete[] listeJeux.elements;
		listeJeux.elements = elementsCopie;
	}
...
Jeu* lireJeu(istream& fichier)
{
	...
	cout << "\nJeu "<<jeu.titre << endl<<endl;  //TODO: Enlever cet affichage temporaire servant à voir que le code fourni lit bien les jeux.
